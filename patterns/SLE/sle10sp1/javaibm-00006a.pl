...
# Title:       IBM Java 1.5 Security Advisory SUSE-SA:2008:025
# Description: IBM Java 1.5 was updated to fix remote code execution security issues, Severity 8 of 10.
...
SDP::Core::processOptions();
	...
	if  ( SDP::SUSE::compareKernel(SLE9SP5) <= 0 ) {
		...
		@PKGS_TO_CHECK       = qw(java-1_5_0-ibm java-1_5_0-ibm-alsa java-1_5_0-ibm-demo java-1_5_0-ibm-devel java-1_5_0-ibm-jdbc java-1_5_0-ibm-plugin java-1_5_0-ibm-src);
		$FIXED_VERSION       = '1.5.0_sr7-0.2';
		SDP::Core::printDebug('ARGS', "$CHECKING, $ADVISORY, $TYPE, $#PKGS_TO_CHECK, $FIXED_VERSION");
		SDP::SUSE::securitySeverityPackageCheck($CHECKING, $ADVISORY, $TYPE, \@PKGS_TO_CHECK, $FIXED_VERSION);
	} else {
