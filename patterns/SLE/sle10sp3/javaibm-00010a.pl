...
# Title:       IBM Java 1.5 Security Advisory SUSE-SA:2010:002
# Description: IBM Java 1.5 was updated to fix remote code execution security issues, CVSS v2 Base Score: 9.3
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://www.novell.com/linux/security/advisories/2010_02_java.html"
);
...
SDP::Core::processOptions();
	...
	if ( SDP::SUSE::compareKernel(SLE10SP3) >= 0 && SDP::SUSE::compareKernel(SLE10SP4) < 0 ) {
		@PKGS_TO_CHECK       = qw(java-1_5_0-ibm java-1_5_0-ibm-64bit java-1_5_0-ibm-demo java-1_5_0-ibm-devel java-1_5_0-ibm-fonts java-1_5_0-ibm-jdbc java-1_5_0-ibm-plugin java-1_5_0-ibm-src);
		$FIXED_VERSION       = '1.5.0_sr11-0.4.2';
		...
		$FIXED_VERSION       = '1.5.0_sr11-0.4.1';
		SDP::SUSE::securitySeverityPackageCheck($CHECKING, $ADVISORY, $TYPE, \@PKGS_TO_CHECK, $FIXED_VERSION);
		...
		if ( $HOST_INFO{'architecture'} =~ /ppc/i ) {
			$FIXED_VERSION = '1.5.0-0.78';
		} else {
			$FIXED_VERSION = '1.5.0-0.76';
		}
		SDP::SUSE::securitySeverityPackageCheck($CHECKING, $ADVISORY, $TYPE, \@PKGS_TO_CHECK, $FIXED_VERSION);
	} else {
