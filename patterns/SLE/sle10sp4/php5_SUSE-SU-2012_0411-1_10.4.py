#!/usr/bin/python
#
# Title:       Important Security Announcement for PHP5 SUSE-SU-2012:0411-1
...
OTHER_LINKS = "META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2012-03/msg00013.html"
...
if ( SERVER['DistroVersion'] == 10):
	if ( SERVER['DistroPatchLevel'] == 4 ):
		PACKAGES = {
			'apache2-mod_php5': '5.2.14-0.26.3',
			'php5': '5.2.14-0.26.3',
