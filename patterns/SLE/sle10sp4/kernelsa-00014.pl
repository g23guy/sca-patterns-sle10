...
# Title:       Kernal SA SUSE-SU-2013:0856-1
# Description: Solves two vulnerabilities and has 8 fixes
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2013-06/msg00000.html"
);
