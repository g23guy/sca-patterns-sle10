...
if ( SERVER['DistroVersion'] == 10):
	if ( SERVER['DistroPatchLevel'] == 0 ):
		PACKAGES = {
			'libnetapi-devel': '3.4.3-0.41.1',
			'libnetapi0': '3.4.3-0.41.1',
			'libtalloc-devel': '3.4.3-0.41.1',
			'libtalloc1': '3.4.3-0.41.1',
			'libtdb-devel': '3.4.3-0.41.1',
			'libtdb1': '3.4.3-0.41.1',
			'libwbclient-devel': '3.4.3-0.41.1',
			'libwbclient0': '3.4.3-0.41.1',
			'samba-gplv3': '3.4.3-0.41.1',
			'samba-gplv3-client': '3.4.3-0.41.1',
			'samba-gplv3-doc': '3.4.3-0.41.1',
			'samba-gplv3-krb-printing': '3.4.3-0.41.1',
			'samba-gplv3-winbind': '3.4.3-0.41.1',
		}
