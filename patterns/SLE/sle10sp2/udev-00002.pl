...
# Title:       udev Security Advisory SUSE-SA:2009:025
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://www.novell.com/linux/security/advisories/2009_25_udev.html"
);
...
SDP::Core::processOptions();
	...
	if  ( SDP::SUSE::compareKernel(SLE10SP2) >= 0 && SDP::SUSE::compareKernel(SLE10SP3) < 0 ) {
		...
		@PKGS_TO_CHECK       = qw(udev udev-debuginfo);
		$FIXED_VERSION       = '085-30.54';
