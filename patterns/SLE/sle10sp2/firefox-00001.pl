...
# Title:       Firefox 2 Security Advisory SUSE-SA:2009:023
# Description: Firefox 2 was updated to fix remote code execution security issues, Severity 8 of 10.
...
@PATTERN_RESULTS = (
	...
	"META_LINK_Security=http://www.novell.com/linux/security/advisories/2009_23_firefox2.html"
);
...
SDP::Core::processOptions();
	...
	if  ( SDP::SUSE::compareKernel(SLE10SP2) >= 0 && SDP::SUSE::compareKernel(SLE10SP3) < 0 ) {
		...
		$FIXED_VERSION       = '2.0.0.21post-0.3';
